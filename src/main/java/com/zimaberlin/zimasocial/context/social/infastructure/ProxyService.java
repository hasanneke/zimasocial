...
import com.zimaberlin.zimasocial.context.social.media.infastructure.movie.TDMBMovieSearcher;
...
public class ProxyService {
    ...
    private final TDMBMovieSearcher tdmbMovieSearcher;

    @Autowired
    public ProxyService(WebClient.Builder builder, SpotifyMusicSearcher spotifyMusicSearcher, TDMBMovieSearcher tdmbMovieSearcher, ServletRequest servletRequest) {
        this.spotifyMusicSearcher = spotifyMusicSearcher;
        this.tdmbMovieSearcher = tdmbMovieSearcher;
    ...
    public ResponseEntity<byte[]> proxy(HttpMethod method,
        ...
        if(uri.getHost().equals("api.spotify.com")){
            ...
            String apiKey = tdmbMovieSearcher.getApiKey();
