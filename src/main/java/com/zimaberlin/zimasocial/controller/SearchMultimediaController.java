...
//
//    @Autowired
//    public SearchMultimediaController(SpotifyMusicClient spotifyMusicService, SearchMovieService movieService, BookSearcher bookSearcher) {
...
//        BookResponseView bookResponseView = bookSearcher.search(query);
//
