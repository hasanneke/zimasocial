...
public class ChatServiceApplication {
    ...
    public ChatRoom createOrFindRoomWithParticipant(AuthorDomainId participantId) {
        AuthorDomainId currentParticipant = authorRepository.getAuthenticatedAuthor().getId();
